...
* :pmmbug:`5064` and :pmmbug:`5065`: Starting from this release, users will be able to integrate PMM with an external Alertmanager by specifying the
  Alertmanager URL and the Alert Rules to be executed inside the PMM server (see :ref:`prometheus-alertmanager-integration`)
