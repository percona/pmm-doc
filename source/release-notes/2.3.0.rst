...
* :pmmbug:`5064` and :pmmbug:`5065`: starting from this release, users will be
  able to integrate PMM with their own Alert Manager and supply PMM dashboards
  with the alert rules, which will be periodically evaluated to send
  notifications when the specified conditions are met
