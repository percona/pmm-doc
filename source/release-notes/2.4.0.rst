...
* :jirabug:`PMM-5445`: Labels change (which occurs e.g. when the metrics resolution is changed on the PMM Settings page) was breaking the HA Dashboards
* :jirabug:`PMM-5439`: Labels change (which occurs e.g. when the metrics resolution is changed on the PMM Settings page) was breaking the Dashboards for the RDS instances
...
* :jirabug:`PMM-5427`: Labels change (which occurs e.g. when the metrics resolution is changed on the PMM Settings page) was breaking the PostgreSQL dashboards
* :jirabug:`PMM-5426`: Labels change (which occurs e.g. when the metrics resolution is changed on the PMM Settings page) was breaking the MongoDB dashboards
* :jirabug:`PMM-5419`: Labels change (which occurs e.g. when the metrics resolution is changed on the PMM Settings page) was breaking the MySQL dashboards
