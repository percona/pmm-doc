...
* :pmmbug:`4779`: Restored Grafana snapshots dialog
* :pmmbug:`4752`: replace refresh parameters for all variables
  page, and a Node row 
...
* :pmmbug:`4755`: Fixed a misprint in the InnoDB AHI Miss Ratio formula
...
* :pmmbug:`4640`: It was not possible to add MongoDB remotely if password had
   a ``#`` symbol
