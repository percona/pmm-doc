...
* :pmmbug:`4916`: Wrong values shown when changing the time range for the Node
  Summary Dashboard in case of remote instances
...
* :pmmbug:`4875`: PostgreSQL error log gets flooded with warnings when
  ``pg_stat_statements`` extension is not installed in the database used by PMM Server or when PostgreSQL user is unable to connect to it
