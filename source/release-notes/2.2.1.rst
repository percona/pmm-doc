...
vulnerability. Any other PMM versions do not carry the same code logic, and are
thus unaffected by this issue. **Users who have already deployed PMM Server 2.2.0
are advised to upgrade to version 2.2.1 which resolves this issue.**
...
* :pmmbug:`5232`: The pmm-managed component of the PMM Server 2.2.0 is
  ...
  PMM Server IP address. Versions other than 2.2.0 are not affected.
