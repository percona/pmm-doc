...
* :jirabug:`PMM-5822`: PMM now includes a Security Threat Tool to help users avoid most common database security issues. Read more `here <https://www.percona.com/doc/percona-monitoring-and-management/2.x/concepts/architecture.html>`_.
