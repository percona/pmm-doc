...
In thisrelease we updated Grafana to version 6.7.4 in order to fix  `CVE-2020-13379 <https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-13379/>`_. We recommend to update to the latest PMM version asap.   
