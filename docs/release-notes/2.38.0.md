...
AMI, OVF users and Docker users who want to upgrade PMM via the **Upggrade Now** option on the Home Dashboard will have to wait a little longer for an automated migration path from Centos 7 to Oracle Linux 9.
...
- [PMM-9224](https://jira.percona.com/browse/PMM-9224) - Arbiter nodes are now correctly displayed on the **MongoDB ReplSet Summary** dashboard.
