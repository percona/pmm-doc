...
As security is paramount to us, PMM 2.38.0, adds a solid and modernized enterprise-grade foundation to PMM. This release migrates our base operating system on which we build our PMM image from CentOS 7 to Oracle Linux 9. Thus, starting with PMM 2.38.0, PMM is publicly available on Oracle Linux 9.
...
If you want to upgrade manually in the meantime, check out the instructions in the [PMM is getting a modernized enterprise-grade foundation blog post](https://www.percona.com/blog/).
