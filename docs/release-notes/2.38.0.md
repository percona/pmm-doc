...
UI - Uncheck the **Disable comments parsing** checkbox for PostgreSQL and MySQL in the **Additional Options** section.
...
- [PMM-9367](https://jira.percona.com/browse/PMM-9367) -   [Backups]: MongoDB Backup: Sharded Cluster Backup
- [PMM-11250](https://jira.percona.com/browse/PMM-11250) - [Backup]: Allow user to specify target directory for backup artifact.
...
- [PMM-9544](https://jira.percona.com/browse/PMM-9544) - [Alerting]: Alerting doesn't seem to be able to monitor for "Host Down"
