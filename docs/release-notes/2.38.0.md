...
AMI, OVF users and Docker users who want to upgrade PMM via the **Upgrade Now** option on the Home Dashboard will have to wait a little longer for an automated migration path from Centos 7 to Oracle Linux 9.
