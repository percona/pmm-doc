...
- [PMM-11250](https://jira.percona.com/browse/PMM-11250) - [Backup]: Added option to specify target directory for the selected backup location location for the backup to improve PMM-PBM integration workflows.
