...
- [PMM-11692](https://jira.percona.com/browse/PMM-11692) - the `Top MySQL Active Client Threads` panel color was misleading. The isuue has been resolved now.
...
- [PMM-12085](https://jira.percona.com/browse/PMM-12085)  - Fixed an issue where SSH access to AMI & OVF images for el9 based images did not work. The issue has been resolved now.
