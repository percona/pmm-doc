...
- [PMM-12494](https://jira.percona.com/browse/PMM-12494) - While trying to upgrade PMM using the docker, an error was being thrown. The issue has been reolved now.
