...
- [PMM-12576](https://jira.percona.com/browse/PMM-12576) - After upgrading PMM from version 2.39.0 to 2.40.0 (not el7) using Docker, the `admin` user cannot access the PMM UI. After upgrading PMM from version 2.39.0 to 2.40.0 (not el7) using Docker, the admin user cannot access the PMM UI. Refer to the [documentation](https://pmm-doc/how-to/troubleshoot.html#pmm-cannot-acess-admin-user-after-upgrading) for information on the solution.
