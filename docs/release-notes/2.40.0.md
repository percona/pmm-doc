...
- [PMM-11770](https://jira.percona.com/browse/PMM-11770)- Ensured that changes made to the PMM public address propagate to grafana.ini. This means that PMM no longer generates incorrect Grafana links in in alerting emails and other notifications.
