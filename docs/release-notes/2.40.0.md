...
!!! caution alert alert-warning "Caution"
    **If you are using the Library Panel on the PMM dashboard, avoid upgrading to PMM 2.40.0 due to a known issue. Instead, we recommend waiting for the release of PMM 2.40.1.**
...
- [PMM-12592](https://jira.percona.com/browse/PMM-12592) - If you are using the **Library Panel** on the PMM dashboard, avoid upgrading to PMM 2.40.0 due to a known issue.