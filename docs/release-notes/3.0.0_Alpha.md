...
Grouping all administration-related tools means that you get a centralized access to all PMM configuration settings, making it easier to find what you need.
