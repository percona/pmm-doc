...
With the release of PMM 3, we are completing the transition away from CentOS/RHEL 7-based builds and fully embracing Oracle Linux 9 as the default operating system for PMM-base images. This transition began with PMM 2.38 and is now being finalized for all users, including those who had upgraded from 2.37 and earlier versions using the **PMM Upgrade** option on the Home Dashboard.
