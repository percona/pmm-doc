...
- [PMM-7559](https://jira.percona.com/browse/PMM-7559): IA: Improve error message when trying to delete a channel that is used by a rule (Thanks to Beata Handzelova for reporting this issue)
...
- [PMM-7985](https://jira.percona.com/browse/PMM-7985): Installed custom Grafana plugins lost after upgrade via Docker TBD (WE need to point ppl into documentation about this fix. It will not work as expected  in the issue )
  The issue is fixed automatically since 2.23.0 version forward.
- [PMM-8767](https://jira.percona.com/browse/PMM-8767): Copied dashboards with tags ended up in unexpected folder after upgrade (Thanks to Beata Handzelova for reporting this issue)
...
- [PMM-8723](https://jira.percona.com/browse/PMM-8723): DBaaS does not work after PMM upgrade (Thanks to Jan Prukner for reporting this issue)
