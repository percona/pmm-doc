...
- **DBaaS (Technical preview):**  Form this release, PMM users who are using the DBaaS feature will be able to update versions of Databases they are using in DBaaS manually according to DB's compatibility matrix. 
