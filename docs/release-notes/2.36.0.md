...
- [PMM-8251](https://jira.percona.com/browse/PMM-8251) - [DBaaS]: Despite the cluster being forcefully unregistered from DBaaS, metrics were still collected. Unregistering K8s should prevent metrics from being collected. This issue has been resolved now.
