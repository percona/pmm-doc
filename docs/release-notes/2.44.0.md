...
This enhancement requires PMM Agent version 2.43.1 or later. Keep in mind that some dashboard panels may need further updates to fully support MongoDB 8.0’s new format.
