...
* [PMM-7048](https://jira.percona.com/browse/PMM-7048): Move Create Cluster button out of Step 2



## Bugs Fixed

* [PMM-7312](https://jira.percona.com/browse/PMM-7312): Error when accessing TimeSeries information panels (with PMM v2.13.0 via Docker, 200+ monitored servers, 2-3 services each)
