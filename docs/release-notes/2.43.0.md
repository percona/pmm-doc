...
We've created a new experimental **MongoDB Router Summary** dashboard that will enhance your experience when monitoring MongoS (routers) of MongoDB sharded clusters:

- MongoS availability (UP or DOWN)
- MongoS version
- CPU / Memory / Disk metrics, and much more

The new dashboard can be found under the "MongoDB / High Availability" menu.
