...
For assistance with migrating to Oracle Linux 9, our expert team is available to support you. For more information, [contact our sales team](https://www.percona.com/about/contact).
...
Node_exporter incorrectly displays a **Done** status instead of **Waiting** when pmm-agent is configured with an incorrect `paths-base` setting.