...
PMM now supports monitoring Percona Backup for MongoDB (PBM) setups through a dedicated collector in the MongoDB exporter, providing key insights into `pbm-agent` statuses, PITR configuration, and backup statuses. Key metrics for this:
