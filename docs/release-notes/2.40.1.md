...
- [PMM-12587](https://jira.percona.com/browse/PMM-12587) - During the upgrade from version 2.39 to 2.40, the process was failing because of incorrect mappings between dashboards, folders, users, and groups. The issue has been resolved.
