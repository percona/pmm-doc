...
- [PMM-12414](https://jira.percona.com/browse/PMM-12414) - There was an unexpected behavior (502 response) when accessing the `logs.zip` endpoint. This was caused by the `group_by` parameter being included in the Alertmanager configuration.
...
- [PMM-12630](https://jira.percona.com/browse/PMM-12630) - Fixed an issue in which the upgrade process for PMM versions lower than or equal to 2.37.1 was stuck in a loop and could not be completed.

## Known issue

- [PMM-12682](https://jira.percona.com/browse/PMM-12682) PMM doesn't show service names within the PMM Dump dataset when the **All Services** option is selected during PMM Dump creation. This issue will be fixed in a future release.