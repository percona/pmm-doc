...
Starting PMM 2.29.0, get your PMM instances up and running quickly with the Podman. 

Deployment with the Podman is far more secure as it does not require root privileges. Also, with Podman, you can exercise control over the layers of the container.
