...
- [PMM-8677] - Fixed the names of the operators used in PMM on the DBaaS UI to reflect their official names rather than short forms.
...
- [PMM-7143](https://jira.percona.com/browse/PMM-7143):
