...
Starting with PMM 2.29.0, you can seamlessly deploy your PMM instances with root privileges on the k8s cluster, a prominent container orchestration system. 
