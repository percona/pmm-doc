...
- [PMM-7612](https://jira.percona.com/browse/PMM-7612): Integrated Alerting: Validate 'From' email address format (Settings → Communication → Email) (Thanks to Beata Handzelova for reporting this issue)
