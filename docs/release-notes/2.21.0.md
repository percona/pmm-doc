...
- **Backup scheduling with retention**: When scheduling a backup you can now specify how many of the most recent backups to keep. Backups not in this range are automatically deleted to free space for new ones.
...
- [PMM-8609](https://jira.percona.com/browse/PMM-8609): Agents stuck in Starting after upgrading PMM Server with +100 services
