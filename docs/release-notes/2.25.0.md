...
- **DBaaS (Technical Preview)**
    - PMM will now let you deploy and update your PXC clusters created with DBaaS functionality to the version of Percona Distribution for MySQL Operator 1.9.0 to deliver the latest fixes in this version.
