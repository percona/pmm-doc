...
- [PMM-11729](https://jira.percona.com/browse/PMM-11729) - Fixed syntax issues with placeholders.
...
## PMM vulnerability details (CVEs)

The following table provides details of the vulnerabilities in PMM 2.37.0:


| **CVE** | **Reference**     | **Severity**     | **Mitigation steps**
|---------------|---------------|---------------|-----------------------------------------------------------------------------------------------------------------
|               |               |               | 
|               |               |               |       
