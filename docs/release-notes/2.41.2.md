...
[PMM-12806](https://perconadev.atlassian.net/browse/PMM-10974) - In prior versions, would give precedence to specific VictoriaMetrics command line flags over environment variables. This behavior has now been changed to prioritize environment variables over CLI flags.
...
[PMM-12806](https://perconadev.atlassian.net/browse/PMM-12806)- In prior versions, PMM Server had certain non-configurable Victoria Metrics settings with default values. This behavior has now been addressed.
