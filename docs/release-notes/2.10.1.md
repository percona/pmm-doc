...
* [PMM-6643](https://jira.percona.com/browse/PMM-6643): New MongoDB exporter has higher CPU usage compared with old ((fixed in [Percona Monitoring and Management 2.10.1](2.10.1.md))
