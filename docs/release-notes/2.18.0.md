...
The goal for this small release was to eliminate some bugs and complete some features.
...
- Backup Management
    ...
    - manage your Storages for backups (S3 only );
...
* [PMM-8029](https://jira.percona.com/browse/PMM-8029): DBaaS: PSMDB 1.8v operator support
...
* [PMM-7315](https://jira.percona.com/browse/PMM-7315): Ensure DB cluster started to be deleted
