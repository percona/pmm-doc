...
* [PMM-7767](https://jira.percona.com/browse/PMM-7767), [PMM-7696](https://jira.percona.com/browse/PMM-7696): Implement feature flag to enable Microsoft Azure monitoring. Users can [use UI](../setting-up/client/azure.md) or Environment Variable (`ENABLE_AZUREDISCOVER=1`) to pass it during the container creation.
