...
- [PMM-11372](https://jira.percona.com/browse/PMM-11372) - Despite removing pmm-server packages before upgrading PMM server, the packages were still present during upgrade. The issue has been resolved now.
