...
- [PMM-10135](https://jira.percona.com/browse/PMM-10135): To safeguard the privacy of our users, we have removed Personally Identifiable Information (PII) from the **Explain** tab. Currently, you cannot see any sensitive data in that tab, but if you need fulfill values to explain, you will be prompted.
