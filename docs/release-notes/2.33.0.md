...
- [PMM-10718](https://jira.percona.com/browse/PMM-10718): [Backup Management]: When taking backups, PMM now shows a clearer error if their pmm-agent is incompatible with the specified backup operation.
