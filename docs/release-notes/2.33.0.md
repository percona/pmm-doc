...
- [PMM-10487](https://jira.percona.com/browse/PMM-10487): [Dashboard]: For PMM 2.33.0, we have added tooltips to panels on the new Experimental MongoDB Dashboards to guide the users while using these dashboards.
