...
!!! caution alert alert-warning "Important"
    An error occurs when upgrading PMM to versions prior to 2.33.0. Thus, we recommend using the latest PMM version. To successfully upgrade to versions prior to 2.32.0, see the [solution](2.33.0.md#known-issues).
