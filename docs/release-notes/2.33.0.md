...
- [11082](https://jira.percona.com/browse/PMM-11082): When adding RDS MySQL instances to pmm-managed, some relevant queries with table stats were executed despite table stats being disabled. The issue has been resolved now.
