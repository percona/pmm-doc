...
!!! caution alert alert-warning "Important"
    HA in PMM will be rolled out in three stages. Stage one of HA in PMM is the implementation to prevent data loss with VictoriaMetrics integration for short outages. HA stages two and three will be rolled out next year.
