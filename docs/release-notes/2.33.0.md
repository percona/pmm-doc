...
- [PMM-10029](https://jira.percona.com/browse/PMM-10029): There was an issue with the network request exceeding the maximum message size. The issue has been resolved now.
