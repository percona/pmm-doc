...
* [PMM-6693](https://jira.percona.com/browse/PMM-6693): The API keys usage.  PMM users can use API keys (generated in Grafana UI ) now for interaction with the PMM server instead of username/password pairs. The API key should have  the same level of access (Admin or Viewer) as it required for username/password pairs 
...
* [PMM-7259](https://jira.percona.com/browse/PMM-7259): Integrated Alerting: Better UI error reporting for disabled Integrated Alerting. Hint to people how to enable it
