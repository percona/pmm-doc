...
- **Expandable navbar (main menu)**
    ...
    For an enhanced user experience and better accessibility, the main menu has been expanded with crucial dashbaords such as system, MongoDB, MySQL, PostgreSQL, ProxySQL, and HAProxy. Thus, these dashbaords cab be accessed upfront which makes it really conveneinet for the users.
