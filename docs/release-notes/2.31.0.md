...
- [PMM-10349](https://jira.percona.com/browse/PMM-10349): DBaaS: Simpler DBaaS and Percona Platform connection configuration by suggesting the public address of the PMM server.
...
- **Percona Backup for MongoDB compatibility**
MongoDB backups in PMM require Percona Backup for MongoDB (BPM) version 1.8.x. Make sure not to install the latest BPM version via the percona-release tool, as this automatically installs BPM v.2.0 which is not yet compatible with PMM. 
