...
- [PMM-10467](https://jira.percona.com/browse/PMM-10467): Custom alert rules created with Integrated Alerting are not automatically migrated to Percona Alerting. After upgrading to PMM 2.31, make sure to manually migrate any custom alert rules that you want to transfer to PMM 2.31 using the script that will be provided soon. 
...
- [PMM-10516](https://jira.percona.com/browse/PMM-10516): Support for physical backups to drastically speed up backup for large databases (several terabytes).
