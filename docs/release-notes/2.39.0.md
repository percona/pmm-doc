...
- [PMM-11206](https://jira.percona.com/browse/PMM-11206) - [Alerting]: PMM users now have the ability to easily add multiple **Alert rule templates** at once, whether through the API or UI. When added in bulk, each template will be displayed separately on the **Alert rule templates** page. This enhancement makes it quicker and more efficient to manage your alert rules.
...
- [PMM-12389](https://jira.percona.com/browse/PMM-12389) - Starting with PMM 2.39.0, the postgres_exporter provides more comprehensive logs that display the specific namespace and error message for any issue.
...
- [PMM-12231](https://jira.percona.com/browse/PMM-12231) - In the recent versions of PMM, users have encountered issues with installing, updating and removing plugins from PMM. For more information on this issue, see [documentation](https://docs.percona.com/percona-monitoring-and-management/how-to/troubleshoot.html#plugins-issues).