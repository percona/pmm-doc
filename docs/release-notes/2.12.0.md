...
* [PMM-6518](https://jira.percona.com/browse/PMM-6518): VictoriaMetrics: Update default datasource name from 'Prometheus' to 'VictoriaMetrics' to ensure graphs are populated correctly after upgrade
