...
If you started using PMM from version 2.16 and have already upgraded to 2.17, 2.18, or 2.19, then you need to perform additional steps after upgrading to 2.20. (This only applies to Docker-based installations.)
...
- [PMM-7649](https://jira.percona.com/browse/PMM-7649): Security Checks: Show "Insufficient access permissions" in UI for non admin users (Thanks to Beata Handzelova for reporting this issue)
