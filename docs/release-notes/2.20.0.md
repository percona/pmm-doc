...
- [PMM-8405](https://jira.percona.com/browse/PMM-8405): MySQL/PostgreSQL/MongoDB Instance Summary and Node Summary dashboards: PT Summary Panel broken after upgrade
