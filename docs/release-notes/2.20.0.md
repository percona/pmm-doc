...
- [PMM-7649](https://jira.percona.com/browse/PMM-7649): Show "Insufficient access permissions" for non admin users (Thanks to Beata Handzelova for reporting this issue)
...
- [PMM-8470](https://jira.percona.com/browse/PMM-8470): PMM Upgrade: What's new link missing (Thanks to Beata Handzelova for reporting this issue)
...
- [PMM-8414](https://jira.percona.com/browse/PMM-8414): Backup Scheduler not working if u specified explicit time of the job start
