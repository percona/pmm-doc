...
- [PMM-11278](https://perconadev.atlassian.net/browse/PMM-12998) - Fixed an issue in the Query Analytics (QAN) dashboard where the Query Count metric displayed incorrect values that did not match the actual number of queries executed.
