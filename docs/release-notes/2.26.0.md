...
We are shipping the [K8s monitoring dashboard](../dashboards/dashboard-cluster-summary.md) as part of our DBaaS feature and Environment Overview dashboard (LINK) in this release.

!!! note alert alert-primary "Note"
    The dashboards can be changed or removed anytime from this folder, so do not build your production system activities around them. It's for testing and feedback purposes only.
...
* [PMM-9059](https://jira.percona.com/browse/PMM-9059): You can now disconnect PMM  from the Percona Platform using the PMM interface.
...
* [PMM-9356](https://jira.percona.com/browse/PMM-9356): Added new experimental Environment dashboards in PMM. Read more [Experimental Environment dashboard](../dashboards/dashboard-env-overview.md).
