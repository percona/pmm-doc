...
You can now create a DBaaS cluster from a backup stored on S3. Currently, you cannot restore a cluster from a backup. You can only create a DBaaS database cluster from backup.
