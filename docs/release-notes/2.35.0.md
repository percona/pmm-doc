...
- [PMM-10962](https://jira.percona.com/browse/PMM-10962) - Starting with PMM 2.35.0, we have introduced Access Control. We have introduced **Configuration > Access Roles**. With this, you can create, edit, and delete user roles. The roles can be assigned to the users with the **Users** tab. Also, on the **Add** and **Edit** pages, you can set the metrics for a particular role.
...
- [PMM-11499](https://jira.percona.com/browse/PMM-11499) - You can now enable Access Control from the **Settings** page on the PMM UI.
