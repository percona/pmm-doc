...
- [PMM-10156](https://jira.percona.com/browse/PMM-10156): [Dashboard]: Starting with PMM 2.32.0, we have an enhanced PMM dashboard that gives a bird-view of the services, infrastructure, and critical issues (if any). Thus, you can effortlessly diagnose the problem from the home dashboard with just one click.
