...
[PMM-11126](https://jira.percona.com/browse/PMM-11126): **PMM server cannot be upgraded to PMM 2.32.0**

A bug in the PMM Server ansible scripts caused PMM to upgrade Nginx's dependencies without updating Nginx itself. Due to this, PMM throws an error while upgrading and cannot upgrade to a newer version.
...
Login to the PMM server and execute the following command:
