...
- [PMM-9545](https://jira.percona.com/browse/PMM-9545):  For effective monitoring of Kubernetes clusters, PMM now collects Kubernetes metrics from kube-state-metrics. For more information on kube-state-metrics, see  [documentation](https://github.com/kubernetes/kube-state-metrics).
