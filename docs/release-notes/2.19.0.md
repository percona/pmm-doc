...
* [PMM-8081](https://jira.percona.com/browse/PMM-8081): Dashboards: Add collection and presentaton for SHUNNED_REPLICATION_LAG state to proxysql_connection_pool_status
