...
For detailed configuration instructions, see [Installation with UI updates](../pmm-upgrade/upgrade_podman.md) and [Manually upgrade PMM Server using Podman](../pmm-upgrade/upgrade_podman.md).
