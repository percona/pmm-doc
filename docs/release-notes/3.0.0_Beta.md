...
You can now upgrade PMM Server installations running under Podman directly through the **PMM Configuration > Updates** panel in the web interface. 
...
For detailed configuration instructions, see [Upgrade PMM Server using Podman](../pmm-upgrade/upgrade_podman.md).
