...
For a comprehensive list of affected plugins and guidance on migration, see [Grafana's official documentation]([https://grafana.com/docs/grafana/latest/developers/angular_deprecation/plugins-using-angularjs/](https://grafana.com/docs/grafana/latest/developers/angular_deprecation/angular-plugins/) on Angular deprecation and plugin migration.
