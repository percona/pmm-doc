...
The integration of the Watchtower container now enables automated updates for AMI and OVF deployments. This enables AMI and OVF deployments to update PMM Server directly from the new **Updates** page.
