...
#### Containerized PMM architecture now standard across AMI and OVF deployments
...
The latest version of MongoDB, along with its Percona version (link provided if released), brings [numerous improvements and significant performance enhancements](https://www.mongodb.com/docs/manual/release-notes/8.0/).
