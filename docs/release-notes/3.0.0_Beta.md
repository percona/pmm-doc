...
You can now run database exporters from any PMM Client node, allowing you to distribute the monitoring load across multiple PMM Agents. This is especially useful for monitoring cloud-hosted databases like RDS.
