...
- Select the node and click **OK**. A page that provides the user with crucial information regarding the total number of agents deployed and their current health status is displayed. 
- Click the **down** arrow under the **Options** column to obtain further details about a specific agent.
