...
PMM is a client/server application built by us with our own and third-party open-source components and tools.
...
- Query Analytics (QAN) enables you to analyze database query performance over periods of time. In addition to the client-side QAN agent, it includes the following:
  ...
  - QAN App is a web application for visualizing collected Query Analytics data (part of PMM Server's UI).
...
- Metrics Monitor provides a historical view of metrics that are critical to a MySQL or MongoDB server instance. It includes the following:
  ...
  - [Percona Dashboards](https://github.com/percona/grafana-dashboards) is a set of dashboards for Grafana developed by us.
