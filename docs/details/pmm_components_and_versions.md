...
| Mysqld exporter| V0.14.0 and Percona changes    | [MySQL Server Exporter Documentation](https://grafana.com/oss/prometheus/exporters/mysql-exporter/)|[Github prometheus/mysqld_exporter](https://github.com/prometheus/prometheus/mysqld_exporter)    |                                          
