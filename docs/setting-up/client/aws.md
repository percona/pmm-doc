...
Alternatively to creating an IAM user you can also create an IAM role for a service to discover Amazon RDS DB instances automatically without the need for access and secret keys.
