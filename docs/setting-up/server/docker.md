...
| `ENABLE_ALERTING`/ 'DISABLE_ALERTING`                           | Enable/ disable Percona alerting.
| `ENABLE_AZUREDISCOVER`                                          | Enable support for discovery of Azure databases.
| `ENABLE_BACKUP_MANAGEMENT`/ `DISABLE_BACKUP_MANAGEMENT`         | Enable/disable backup and restore tools.
