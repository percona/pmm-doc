...
!!! caution alert alert-warning "Important"
    Grafana plugins have been moved to the data volume `/srv` since 2.23.0 version. So if any plugin is installed manully than it should be install again after an upgrade.
