...
|DATA_RETENTION|How long keep time-series data in ClickHouse expresed in days|
|ENABLE_VM_CACHE|Enable cache in VM|
|ENABLE_ALERTING|Enable integrated alerting|
|ENABLE_AZUREDISCOVER|Enable support for discovery Azure databases|
...
|ENABLE_DBAAS|Enable Database as a Service features|
...
|GF\_\*|Grafana's environment variables|
|SUPERVISOR\_|Supervisord environment variables|
|PERCONA_TEST\_|Unknown variable but won't prevent the server to start|
