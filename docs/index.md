...
- The [Quickstart install guide](../docs/quick\start/index.md) shows how to run PMM Server as a Docker container, and how to install PMM Client on Ubuntu or Red Hat Linux hosts.
