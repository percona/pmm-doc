...
You can change the standard 24-hours interval to a custom frequency for each Advisor check:
...
PMM Advisors offer a sets of checks that can detect common security threats, performance degradation, data loss and data corruption. 
