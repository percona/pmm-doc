...
2. [Prepare and create a storage location for your backups](/../pmm-doc/docs/get-started/backup/prepare_storage_location.md).
...
4. Check that [PMM Client](../../../percona/pmm-doc/pmm-doc/docs/setting-up/client/index.md) is installed and running at least on one node of the replica set. Make sure this is the one that will be used for backup and restore jobs.
