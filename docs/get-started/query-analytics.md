...
In QAN we supporting two types of query source. Its `pg_stat_monitor` and pg_stat_statements `pg_stat_statements`. In the past PGSS were default query source, but since this version its newly PGSM. 
